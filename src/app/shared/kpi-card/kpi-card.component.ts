...
export type KpiCardColor = 'orange' | 'blue' | 'red' | 'green' | 'purple' | 'solid-blue';
...
const KPI_COLOR_THEMES: Record<string, {
    ...
    orange: {
        cardBorder: 'border-[#bc9551] hover:border-[#bc9551] dark:border-amber-500/30 dark:hover:border-amber-500/60',
        cardBg: 'bg-[#bc9551]/90 first-card via-surface-0 to-surface-0/90 dark:from-amber-500/[0.12] dark:via-surface-900 dark:to-surface-900/90',
        glowBg: 'bg-[#bc9551]/15 dark:bg-amber-500/20',
        iconBg: 'bg-[#bc9551]/15 dark:bg-amber-500/25',
        iconColor: 'text-[#bc9551] dark:text-amber-400',
        pillBg: 'bg-[#bc9551]/15 dark:bg-amber-500/20',
        pillText: 'text-[#ffffff] dark:text-amber-300',
        accentLine: 'bg-[#bc9551]'
    },
    'solid-blue': {
        cardBorder: 'border-[#0084ca] hover:border-[#0084ca] dark:border-sky-500/30 dark:hover:border-sky-500/60',
        cardBg: 'bg-[#0084ca] first-card via-surface-0 to-surface-0/90 dark:from-sky-500/[0.12] dark:via-surface-900 dark:to-surface-900/90',
        glowBg: 'bg-[#0084ca]/15 dark:bg-sky-500/20',
        iconBg: 'bg-[#0084ca]/15 dark:bg-sky-500/25',
        iconColor: 'text-white dark:text-white',
        pillBg: 'bg-white dark:bg-sky-500/20',
        pillText: 'text-white dark:text-white',
        accentLine: 'bg-[#0084ca]'
    },
    blue: {
        cardBorder: 'border-sky-100 hover:border-sky-600 dark:border-sky-500/30 dark:hover:border-sky-500/60',
    ...
    red: {
        cardBorder: 'border-rose-100 hover:border-rose-600 dark:border-rose-500/30 dark:hover:border-rose-500/60',
    ...
    green: {
        cardBorder: 'border-emerald-100 hover:border-emerald-600 dark:border-emerald-500/30 dark:hover:border-emerald-500/60',
    ...
    purple: {
        cardBorder: 'border-purple-100 hover:border-purple-500/40 dark:border-purple-500/30 dark:hover:border-purple-500/60',
